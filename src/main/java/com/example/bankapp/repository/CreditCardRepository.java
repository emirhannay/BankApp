...
public interface CreditCardRepository extends JpaRepository<CreditCard,Long> {
    ...
    @Query(value = "SELECT * FROM CREDIT_CARD AS C INNER JOIN CARD AS A ON C.CARD_ID = A.ID WHERE A.CARD_NO = :cardNo",nativeQuery = true)
    CreditCard findByCardNo(@Param("cardNo") Long cardNo);
