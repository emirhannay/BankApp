...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query(value = "SELECT * FROM CUSTOMER AS C INNER JOIN USER AS U" +
                   " ON C.USER_ID = U.ID" +
    ...
    @Query(value = "SELECT * FROM CUSTOMER AS C INNER JOIN USER AS U ON C.USER_ID = U.ID WHERE U.IS_DELETED = 'FALSE' AND U.USER_STATUS = 'ACTIVE'",nativeQuery = true)
